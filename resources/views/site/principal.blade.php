                ...
                <div class="area-form mt75">
                    <form id="fipe" method="get" action="{{route('venda')}}">
                       ...
                       <!-- <p class="titulo-form">Qual carro você quer vender?</p>
                        ...
                        <div class="area-select">
                            <span class="seta-select"></span>
                            <select  id="marca" name="marca" class="form-control" aria-invalid="true">
                        ...
                        <div class="area-select">
                            <span class="seta-select"></span>
                            <select required="" class="form-control" name="modelo" id="modelo" aria-invalid="true">
                                <option value="">Modelo</option>
                            </select>
                        </div>
                        <div class="area-select">
                            <span class="seta-select"></span>
                            <select required="" class="form-control" name="ano" id="ano" aria-invalid="true">
                                <option value="">Ano</option>
                            </select>
                        </div>
...
<section id="video" class="pb0">
    <div class="container">
        ...
        <div class="row text-center">
            <div class="bg-fundo-video">
                <div class="video-wrap">
                    <div class="video-container">
                        <iframe  src="https://www.youtube.com/embed/aCDaJdFJQyA" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
